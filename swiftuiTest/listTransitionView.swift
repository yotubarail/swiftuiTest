    ...
    var body: some View {
        NavigationView {
            List {
                ...
                NavigationLink("BasicListViewに遷移", destination: BasicListView())
                NavigationLink("connpassListViewに遷移", destination: connpassListView())
                NavigationLink("EnvironmentViewに遷移", destination: EnvironmentView())
